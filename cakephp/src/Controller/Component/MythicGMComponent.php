...
class MythicGMComponent extends Component
{
    ...
    public function eventMeaning($meaning_type): array 
    {
        ...
        $meaning_table_action2 = [
            ...
            // Values are the same as in "action": We do not want to push copyrighted content to github. This values shoudl be changed with the values from the book
            $meaning_table_description1 = [
                __('Abandon'),
                __('Accompany'),
                __('Activate'),
                __('Agree'),
        ...
        if ($meaning_type == "description") {
            return ['first' => $meaning_table_description1[rand(0, 99)], 'second' => $meaning_table_description2[rand(0, 99)]];
        } else if($meaning_type == "element") {
            return ['first' => $meaning_table_element1[rand(0, 99)], 'second' => $meaning_table_element2[rand(0, 99)]];
        } else {
